  ...
  return (
    <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
      <div className="w-full mx-auto space-y-4 text-center">
        <h1 className="text-4xl font-bold  italic leading-tight md:text-5xl">
          Welcome{" "}
        ...
        <p className="text-sm dark:text-gray-600">
          ...
          >
            <span itemprop="name" className="text-purple-700">
              {user?.displayName ? user.displayName : ""}
            </span>
          </a>
          on
      ...
      <div className="pt-12 border-t dark:border-gray-300">
        <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
          ...
          <div className="flex flex-col space-y-5">
            ...
            <p className="dark:text-gray-600 text-sm">Email :{user.email}</p>
            <Link
              to="updateProfile"
              type="button"
              className="btn bg-purple-400 text-white w-1/2"
            >
              Update
            </Link>
          </div>
