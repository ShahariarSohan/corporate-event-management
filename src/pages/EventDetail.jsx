...
const EventDetail = () => {
  ...
  const { title, image, contactInfo, description, status } = selectedEvent;
  return (
    <div className="p-5">
      <div className="flex flex-col container mx-auto p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800 my-10">
        <div>
          <img
            src={image}
            alt=""
